...
food_items={1:{'itemName' : 'glucos', 'itemiD': 1, 'Quantity': '200ml', 'Price': '45', 'Stock': 25},
            2:{'itemName' : 'meggie', 'itemiD': 2, 'Quantity': '4pices', 'Price': '67', 'Stock': 65},
            3:{'itemName' : 'coffee', 'itemiD': 3, 'Quantity': '250gm', 'Price': '320', 'Stock': 80}}
def  add_items():
...
def show():
    ...
    for i in food_items:
         ...
         print("total item",food_items[i],["Quantity"])
